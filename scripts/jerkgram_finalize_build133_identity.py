...
# Telegram 12.9.2 / Jerkgram display name; Build137 preserves the public bundle.
...
def require(value: bool, message: str) -> None:
    if not value:
        raise RuntimeError("[Build137 identity] " + message)
...
def main() -> None:
    ...
    print("[Build137 identity] GREEN")
    print("[Build137 identity] com.jerkgram.ios / CFBundleShortVersionString=12.9.2 / CFBundleVersion=137")
    print("[Build137 identity] in-app Jerkgram release: 1.0.2 Beta 2 (1.0.2-beta.2)")
