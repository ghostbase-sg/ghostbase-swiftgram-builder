...
# Telegram 12.9.2 / Jerkgram display name; Build135 preserves the public bundle.
...
def require(value: bool, message: str) -> None:
    if not value:
        raise RuntimeError("[Build135 identity] " + message)
...
def main() -> None:
    ...
    print("[Build135 identity] GREEN")
    print("[Build135 identity] com.jerkgram.ios / CFBundleShortVersionString=12.9.2 / CFBundleVersion=135")
    print("[Build135 identity] in-app Jerkgram release: 1.0.2 Beta 2 (1.0.2-beta.2)")
