...
def main() -> None:
    ...
    # Verify the exact source that will be copied, then verify the published
    # byte-identical artifact again. A wrong Bundle ID / Telegram version must
    # never survive merely because an earlier intermediate happened to pass.
    verify(source)
    base.main()
