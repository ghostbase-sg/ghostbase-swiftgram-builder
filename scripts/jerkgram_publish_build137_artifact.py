...
base.EXPECTED_BUILD = "137"
base.OUTPUT_IPA = Path("artifacts/Jerkgram-Build137.ipa")
base.OUTPUT_INFO = Path("artifacts/Jerkgram-Build137-info.txt")
...
def main() -> None:
    ...
    info = info.replace("Build=122", "Build=137")
    info += (
    ...
    print("[Build137 artifact] exact public identity verified before and after publication")
