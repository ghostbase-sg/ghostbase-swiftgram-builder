...
def verify_settings_owner(text: str) -> None:
    ...
    require("ItemListSwitchItem(" in text and "systemStyle: .glass" in text, "interactive rows lost the 26pt glass rounding")
...
def main() -> None:
    ...
    print("[Build136 release UI verify] 26pt rounded interactive rows + plain status text / 1.0.2 Beta 2 / Build 136 / Telegram Base 12.9.2")
