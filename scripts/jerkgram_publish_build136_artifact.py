...
base.EXPECTED_BUILD = "136"
base.OUTPUT_IPA = Path("artifacts/Jerkgram-Build136.ipa")
base.OUTPUT_INFO = Path("artifacts/Jerkgram-Build136-info.txt")
...
def main() -> None:
    ...
    info = info.replace("Build=122", "Build=136")
    info += (
    ...
    print("[Build136 artifact] exact public identity verified before and after publication")
