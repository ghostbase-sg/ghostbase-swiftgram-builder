...
def main() -> None:
    ...
    print("[Build134 telemetry v2.1] SOURCE PATCHED")
    print("[Build134 telemetry v2.1] appVersion=1.0.2-beta.2 / build=134 / schema=1 / full legacy payload + Moscow day counters")
